...
<body>
     <main>
@section('header')
         <section class="header  light_head ">
            <div class="head_main ">
            ...
            <div class="d-flex justify-content-between align-item-center bigContainer">
                    ...
                    <div class="footer_text d-flex align-item-center">
                        ...
                        <div id="foot" style="display:none" class="modal_block">
                                    ...
                                    <form action="{{ route('send zayavku email') }}" method="post">
                                        ...
                                        <input type="text" name="phone" name="phone" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 43' placeholder="+7 (___) ___-__-__" id="tel" required>
