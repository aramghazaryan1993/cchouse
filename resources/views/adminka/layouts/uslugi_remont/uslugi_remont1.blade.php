    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Услуги ремонт 1</h4>
        ...
        <div class="modal-body">
         ...
         <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  @foreach($ShowRemont as $value)
                  <form class="forms-sample" action="{{ route('edit uslugi remont1',['id'=>$value->id]) }}" method="POST">
                    @csrf
                     <div class="form-group">
                      <textarea class="form-control summernote" rows="4" name="remont1">{{$value->remont1}}</textarea>
                    </div>
