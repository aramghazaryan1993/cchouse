    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Главная 2</h4>
        ...
        <div class="modal-body">
         ...
         <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  @foreach ($showHome as $value)
                  <form class="forms-sample" method="post" action="{{route('edit home 2', ['id' => $value->id])}}">
                    {{csrf_field()}}
                    <div class="form-group">
                      <input type="text" class="form-control"  value="{{ $value->home3 }}" name="home3">
                    </div>
